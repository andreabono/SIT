...
public class AddMomenttensorRequestData {
  ...
  **/
   ...
   * @return the AddMomenttensorRequestData instance itself
   */
  public AddMomenttensorRequestData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddMomenttensorRequestData addMomenttensorRequestData = (AddMomenttensorRequestData) o;
    return Objects.equals(this.focalmechanismid, addMomenttensorRequestData.focalmechanismid) &&
        Objects.equals(this.momenttensor, addMomenttensorRequestData.momenttensor)&&
        Objects.equals(this.additionalProperties, addMomenttensorRequestData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(focalmechanismid, momenttensor, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddMomenttensorRequestData {\n");
    sb.append("    focalmechanismid: ").append(toIndentedString(focalmechanismid)).append("\n");
  ...
  static {
    ...
    openapiFields.add("focalmechanismid");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddMomenttensorRequestData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddMomenttensorRequestData is not found in the empty JSON string", AddMomenttensorRequestData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddMomenttensorRequestData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddMomenttensorRequestData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddMomenttensorRequestData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddMomenttensorRequestData.class));

       return (TypeAdapter<T>) new TypeAdapter<AddMomenttensorRequestData>() {
           @Override
           public void write(JsonWriter out, AddMomenttensorRequestData value) throws IOException {
           ...
           @Override
           public AddMomenttensorRequestData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AddMomenttensorRequestData instance = thisAdapter.fromJsonTree(jsonObj);
