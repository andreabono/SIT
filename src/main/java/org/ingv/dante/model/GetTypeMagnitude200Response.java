...
public class GetTypeMagnitude200Response {
  ...
  private List<ObjectTableTypeMagnitude> data;
  ...
  **/
  ...
  public GetTypeMagnitude200Response links(List<MetaDefinitionLinksInner> links) {
    this.links = links;
    return this;
  }

  public GetTypeMagnitude200Response addLinksItem(MetaDefinitionLinksInner linksItem) {
    if (this.links == null) {
  ...
  **/
   ...
   * @return the GetTypeMagnitude200Response instance itself
   */
  public GetTypeMagnitude200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentPage, getTypeMagnitude200Response.currentPage) &&
        ...
        Objects.equals(this.additionalProperties, getTypeMagnitude200Response.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetTypeMagnitude200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTypeMagnitude200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTypeMagnitude200Response is not found in the empty JSON string", GetTypeMagnitude200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ObjectTableTypeMagnitude.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTypeMagnitude200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTypeMagnitude200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTypeMagnitude200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTypeMagnitude200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTypeMagnitude200Response>() {
           @Override
           public void write(JsonWriter out, GetTypeMagnitude200Response value) throws IOException {
           ...
           @Override
           public GetTypeMagnitude200Response read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             GetTypeMagnitude200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GetTypeMagnitude200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTypeMagnitude200Response
  * @throws IOException if the JSON string is invalid with respect to GetTypeMagnitude200Response
  */
  public static GetTypeMagnitude200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTypeMagnitude200Response.class);
  }

 /**
  * Convert an instance of GetTypeMagnitude200Response to an JSON string
  *
  * @return JSON string
  */
