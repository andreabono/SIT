...
public class Quake2kSchemaEwLogo {
  ...
  **/
   ...
   * @return the Quake2kSchemaEwLogo instance itself
   */
  public Quake2kSchemaEwLogo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Quake2kSchemaEwLogo quake2kSchemaEwLogo = (Quake2kSchemaEwLogo) o;
    return Objects.equals(this.type, quake2kSchemaEwLogo.type) &&
        Objects.equals(this.module, quake2kSchemaEwLogo.module) &&
        Objects.equals(this.installation, quake2kSchemaEwLogo.installation) &&
        Objects.equals(this.user, quake2kSchemaEwLogo.user) &&
        Objects.equals(this.hostname, quake2kSchemaEwLogo.hostname) &&
        Objects.equals(this.instance, quake2kSchemaEwLogo.instance)&&
        Objects.equals(this.additionalProperties, quake2kSchemaEwLogo.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Quake2kSchemaEwLogo {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Quake2kSchemaEwLogo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Quake2kSchemaEwLogo is not found in the empty JSON string", Quake2kSchemaEwLogo.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Quake2kSchemaEwLogo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Quake2kSchemaEwLogo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Quake2kSchemaEwLogo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Quake2kSchemaEwLogo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Quake2kSchemaEwLogo.class));

       return (TypeAdapter<T>) new TypeAdapter<Quake2kSchemaEwLogo>() {
           @Override
           public void write(JsonWriter out, Quake2kSchemaEwLogo value) throws IOException {
           ...
           @Override
           public Quake2kSchemaEwLogo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             Quake2kSchemaEwLogo instance = thisAdapter.fromJsonTree(jsonObj);
