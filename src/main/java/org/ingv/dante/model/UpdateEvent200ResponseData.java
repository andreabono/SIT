...
public class UpdateEvent200ResponseData {
  ...
  **/
   ...
   * @return the UpdateEvent200ResponseData instance itself
   */
  public UpdateEvent200ResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEvent200ResponseData updateEvent200ResponseData = (UpdateEvent200ResponseData) o;
    return Objects.equals(this.event, updateEvent200ResponseData.event)&&
        Objects.equals(this.additionalProperties, updateEvent200ResponseData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateEvent200ResponseData {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEvent200ResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEvent200ResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEvent200ResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEvent200ResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEvent200ResponseData>() {
           @Override
           public void write(JsonWriter out, UpdateEvent200ResponseData value) throws IOException {
