...
public class UpdateEventsGroupRequest {
  ...
  **/
   ...
   * @return the UpdateEventsGroupRequest instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateEventsGroupRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEventsGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        UpdateEventsGroupRequestData.validateJsonElement(jsonObj.get("data"));
      }
  }
