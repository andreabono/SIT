...
import org.ingv.sit.utils.SelectionRectangle;
...
public class Selector {
  ...
  //  private Label infoLabel;
     ...
     */
    public Selector(ScatterChart<?,?> chart, AnchorPane pane) {
        this.pane = pane;
        this.chart = chart;
...
//    }
    ...
    private final class MouseDraggedHandler implements EventHandler<MouseEvent> {
        ...
        public void handle(final MouseEvent event) {
            ...
            if  (selectionRectangleStart==null) selectionRectangleStart  = computeRectanglePoint(event.getX(), event.getY());
